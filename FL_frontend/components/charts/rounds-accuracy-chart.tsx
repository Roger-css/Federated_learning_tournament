...
export function RoundsAccuracyChart({ rounds }: Props) {
  const data = buildRoundRows(rounds, 'accuracy')
    ...
    <ResponsiveContainer width="100%" height={260}>
      <LineChart data={data} margin={{ top: 4, right: 16, left: 0, bottom: 4 }}>
        ...
        <YAxis
          ...
          tick={{ fontSize: 11 }}
          stroke="var(--muted-foreground)"
          label={{ value: 'Accuracy', angle: -90, position: 'insideLeft', fontSize: 11, offset: 8 }}
        />
        <Tooltip
